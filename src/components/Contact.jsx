  ...
  return (
    <section id="contacto" className="contact-section">
      ...
      <div style={{
        ...
        maxWidth: '700px', margin: '0 auto', padding: '0 2rem', gap: '2rem',
      }}>
        <h2 style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: '800', color: '#ffffff', lineHeight: '1.15', margin: 0 }}>
          {t.heading}
        </h2>

        <p style={{ fontSize: 'clamp(1rem, 2vw, 1.2rem)', color: '#86efac', lineHeight: '1.6', margin: 0, maxWidth: '520px' }}>
          {t.subheading}
        </p>
