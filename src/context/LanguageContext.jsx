  ...
  ES: {
    ...
    aboutMe: {
      ...
      skills: [
        ...
        { name: 'Atención al detalle', level: 88 },
        { name: 'Comunicación', level: 85 },
        { name: 'Organización', level: 87 },
        ...
        { name: 'Constancia y disciplina', level: 100 },
